...
const THEME_DEFAULTS = {
  ...
  textMain: '#2f372f',
  headingText: '#2f372f',
  titleDisplayText: '#f8f6ef',
  mutedText: '#6a7263',
  detailLabelText: '#7a806f',
  groupHeadingText: '#2f372f',
  sectionTitleText: '#2f372f',
  sidebarBg: '#fbf8f1',
  sidebarBorder: '#d8d0bf',
  groupBgTop: '#f7f3ea',
  groupBgBottom: '#eee7d7',
  groupBorder: '#d9d1be',
  sectionBg: '#fffdf8',
  sectionBorder: '#d8d0bf',
  floatingBg: '#fbf8f1',
  floatingBorder: '#d6cfbf',
  accent: '#86a66b',
  accentHover: '#95b47a',
  buttonPrimaryText: '#f8f6ef',
  buttonPrimaryBg: '#5f7b4b',
  buttonPrimaryHover: '#6f8b5b',
  buttonPrimaryBorder: '#4f683f',
  buttonPrimaryActiveBg: '#88a76d',
  buttonPrimaryActiveHover: '#98b780',
  buttonPrimaryActiveBorder: '#6f8b58',
  buttonSecondaryBg: '#dfe8d6',
  buttonSecondaryHover: '#d2dec7',
  buttonSecondaryBorder: '#aebf9b',
  buttonSecondaryText: '#33412f',
  ghostHover: '#ece7da',
  utilityPanelBg: '#f1ece1',
  utilityTintBg: '#e5eddc',
  studioCardBg: '#eef2e6',
  controlInputBg: '#fffdf8',
  titleBarBg: '#cfd8c5',
  titleInputBg: '#6e8475',
  titleInputBorder: '#97a68f',
  titlePlaceholder: '#eef3ea',
  sliderTrackBg: '#cdd6c5',
  sliderDotBg: '#fffdf8',
  sliderDotBorder: '#a6b097',
  sliderLabelActive: '#3a4635',
  sliderLabelInactive: '#7a806f',
  toggleBgOpen: '#e6eddc',
  toggleBgClosed: '#dde4d5',
  toggleBorder: '#b2bea6',
  toggleAccent: '#88a36f',
  toggleText: '#4b5c49',
  toggleTextHover: '#2f372f',
  mapCanvasBg: '#e4e9e1',
  mapFrameBg: '#ece5d5',
  mapFrameBorder: '#8f8776',
  mapLandFill: '#ddd7bf',
  mapLandStroke: '#938a73',
  mapGridStroke: '#bcc5bd',
  mapEdge: '#84715d',
  mapEdgeHover: '#97816a',
  mapEdgeActive: '#72604f',
  mapEdgeSelected: '#594a3d',
  mapNode: '#8ea57b',
  mapNodeCluster: '#ab8f74',
  mapNodeAnimated: '#779165',
  mapNodeSelected: '#4c5f42',
  ...
  mapTextureSea: '#d8e0d5',
  mapTextureSeaLine: '#b4beb5',
  mapTextureLandTint: '#cbc4a7',
  mapTextureLandLine: '#a59a7f',
  mapTextureFrameWash: '#e5dcc8',
  mapTextureCompass: '#857963',
  mapWarningBg: '#7e8b72',
  mapWarningText: '#ffffff',
  fileChipBg: '#e1ead9',
  fileChipBorder: '#b1c09f',
  fileChipText: '#33412f',
  textareaBg: '#fffdf8',
  textareaBorder: '#d8d0bf',
  textareaText: '#33412f',
  textareaMutedText: '#7a806f',
  panelCardBg: '#fffdf8',
  panelCardBorder: '#d8d0bf',
  panelCardText: '#33412f',
  panelCardMutedText: '#6d7466',
  panelCardHover: '#f5f1e7',
  statCardBg: '#ece9dc',
  statCardText: '#33412f',
  statCardMutedText: '#6f7469',
  inputBg: '#fffdf8',
  inputBorder: '#d8d0bf',
  inputText: '#33412f',
  inputPlaceholder: '#848978',
  emptyStateBg: '#f3efe5',
  emptyStateBorder: '#d8d0bf',
  emptyStateText: '#6d7466',
  emptyStateHeading: '#33412f',
  overlayCardBg: '#fbf8f1',
  overlayCardBorder: '#d8d0bf',
  overlayCardText: '#33412f',
  overlayCardMutedText: '#70776a',
  pickerBg: '#fbf8f1',
  pickerBorder: '#d8d0bf',
  pickerText: '#33412f',
  pickerMutedText: '#757c6e',
  pickerHoverBg: '#eef2e6',
  iconButtonBg: '#e8ede0',
  iconButtonBorder: '#b4bea7',
  iconButtonText: '#55654e',
  iconButtonHoverBg: '#dde6d4',
  iconButtonHoverText: '#33412f',
  linkText: '#627f56',
  linkHoverText: '#4d6743',
};
