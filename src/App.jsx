...
function parseQuadraticPath(path) {
...
function pointToQuadraticDistance(px, py, curve) {
...
function buildDefaultMapView(nodes, width, height, clampScale) {
...
function buildClusteredNodes(nodes, thresholdPx, clusterSingularLabel, clusterPluralLabel) {
  const clusters = [];
...
function buildVisibleLabelIds(labelCandidates, showLabels, labelDensityThreshold, labelFontSize, labelOffset) {
